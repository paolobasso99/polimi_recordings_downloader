...
from parsers import recordings_from_webpage_url, recordings_from_webpage_file
...
def webpage_url(
    ...
    # Get recordings
    recordings: List[Recording] = recordings_from_webpage_url(
        url=url, course=course, academic_year=academic_year
    )
...
@app.command()
def webpage_html(
    file: str = typer.Argument(..., help="The path to the HTML file"),
    course: str = typer.Option(..., help="The course name"),
    academic_year: str = typer.Option(
        ..., help='The course academic year in the format "2021-22"'
    ),
    ...
    # Get recordings
    recordings: List[Recording] = recordings_from_webpage_file(
        file=file, course=course, academic_year=academic_year
    )
